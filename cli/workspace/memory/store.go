...
directives=...          (standing instructions the user gave about HOW to work with them; semicolon-separated. Scope a rule to ONE project with the prefix "[scope:<project>] rule" — scoped rules are only injected when that project's workspace is active)
