...
const CoderSystemPrompt = `
    ...
    REGRAS OBRIGATÓRIAS:
    1) Antes de agir, escreva um <reasoning> curto com uma LISTA DE TAREFAS numeradas (1., 2., 3., etc.).
       - Cada tarefa deve ser uma linha independente com numeração.
       - Conforme concluir uma tarefa, marque com [x] no início da linha (ex: 1. [x] Tarefa concluída).
