...
type ChatCLI struct {
	...
	lastPromptChars int
	// skillBodiesInjected maps a skill name to the fingerprint of the body
	// already inlined in THIS conversation's chat prefix. A skill that
	// activates on many turns shipped its whole body every time, while the
