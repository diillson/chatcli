...
func (cli *ChatCLI) showConfigProviders() {
	...
	kv(p, PromptCacheKeepAliveEnv, envOr(PromptCacheKeepAliveEnv))
	kv(p, "CHATCLI_TURN_SCOPED_SYSTEM", envOrDefault("CHATCLI_TURN_SCOPED_SYSTEM", "on"))
	kv(p, "CHATCLI_PROMPT_CACHE_EXPLICIT", envOr("CHATCLI_PROMPT_CACHE_EXPLICIT"))
	...
	kv(p, "DEVIN_CLI_RESPECT_WORKSPACE_TRUST", envOr("DEVIN_CLI_RESPECT_WORKSPACE_TRUST"))
	...
	kv(p, "BEDROCK_BASE_URL", envOr("BEDROCK_BASE_URL"))
	kv(p, "BEDROCK_CONTROL_BASE_URL", envOr("BEDROCK_CONTROL_BASE_URL"))
	kv(p, "BEDROCK_MANTLE_BASE_URL", envOr("BEDROCK_MANTLE_BASE_URL"))
	kv(p, "AWS_ENDPOINT_URL_BEDROCK_RUNTIME", envOr("AWS_ENDPOINT_URL_BEDROCK_RUNTIME"))
	kv(p, "AWS_ENDPOINT_URL_BEDROCK", envOr("AWS_ENDPOINT_URL_BEDROCK"))
...
func (cli *ChatCLI) showConfigAgent() {
	...
	kv(p, "CHATCLI_AGENT_RUNS_HISTORY", envOr("CHATCLI_AGENT_RUNS_HISTORY"))
	kv(p, "CHATCLI_BOARD_PATH", envOr("CHATCLI_BOARD_PATH"))
	...
	kv(p, refusalFallbackEnv, envOr(refusalFallbackEnv))
	kv(p, skillInjectBudgetEnvVar, envOr(skillInjectBudgetEnvVar))

	fmt.Println(p)
	subheader(p, "cfg.sub.agent.execution")
	kv(p, "CHATCLI_AGENT_TOOL_CATALOG", envOr("CHATCLI_AGENT_TOOL_CATALOG"))
	kv(p, "CHATCLI_AGENT_TOOLGUARD", envBool("CHATCLI_AGENT_TOOLGUARD"))
	kv(p, "CHATCLI_AGENT_PLUGIN_TIMEOUT", envOr("CHATCLI_AGENT_PLUGIN_TIMEOUT"))
	kv(p, "CHATCLI_AGENT_PLUGIN_MAX_TURNS", envOr("CHATCLI_AGENT_PLUGIN_MAX_TURNS"))
	kv(p, "CHATCLI_CODER_SANDBOX_IMAGE", envOr("CHATCLI_CODER_SANDBOX_IMAGE"))
	kv(p, "CHATCLI_PARK_DIR", envOr("CHATCLI_PARK_DIR"))
	kv(p, "CHATCLI_SKILLS_ENABLED", envBool("CHATCLI_SKILLS_ENABLED"))
	kv(p, "CHATCLI_SELFEVOLVE_MODE", envOr("CHATCLI_SELFEVOLVE_MODE"))
	kv(p, "CHATCLI_THREATSCAN", envBool("CHATCLI_THREATSCAN"))
	kv(p, "CHATCLI_GRAPH_INDEX", envOr("CHATCLI_GRAPH_INDEX"))
	kv(p, "CHATCLI_MOA_MODELS", envOr("CHATCLI_MOA_MODELS"))
	kv(p, "CHATCLI_MOA_AGGREGATOR", envOr("CHATCLI_MOA_AGGREGATOR"))
	kv(p, "CHATCLI_SCHEDULER_SPEC", envOr("CHATCLI_SCHEDULER_SPEC"))
	...
	kv(p, "CHATCLI_BROWSER_PROFILE", envOr("CHATCLI_BROWSER_PROFILE"))
	kv(p, "CHATCLI_BROWSER_CDP_URL", envOr("CHATCLI_BROWSER_CDP_URL"))
	kv(p, "CHATCLI_CODER_SANDBOX", envOr("CHATCLI_CODER_SANDBOX"))
	kv(p, "CHATCLI_CODER_CHECKPOINTS", envBool("CHATCLI_CODER_CHECKPOINTS"))
	kv(p, "CHATCLI_CODER_CHECKPOINT_TIMEOUT", envOr("CHATCLI_CODER_CHECKPOINT_TIMEOUT"))
...
func (cli *ChatCLI) showConfigResilience() {
	...
	kv(p, HistoryRewritePressureEnv, envOr(HistoryRewritePressureEnv))
...
func (cli *ChatCLI) showConfigIntegrations(ctx context.Context) {
	...
	kv(p, "CHATCLI_MCP_ELICITATION", envOr("CHATCLI_MCP_ELICITATION"))
	kv(p, "CHATCLI_MCP_PERMISSION_TIMEOUT", envOr("CHATCLI_MCP_PERMISSION_TIMEOUT"))
	kv(p, "CHATCLI_MCP_OAUTH_PORT", envOr("CHATCLI_MCP_OAUTH_PORT"))
	...
	kv(p, "CHATCLI_WEBFETCH_RENDER", envOr("CHATCLI_WEBFETCH_RENDER"))
	kv(p, "CHATCLI_WEBFETCH_RENDER_TIMEOUT", envOr("CHATCLI_WEBFETCH_RENDER_TIMEOUT"))
	kv(p, "CHATCLI_WEBFETCH_RENDER_BROWSER", envOr("CHATCLI_WEBFETCH_RENDER_BROWSER"))
	kv(p, "CHATCLI_WEBFETCH_RENDER_AUTOPROVISION", envBool("CHATCLI_WEBFETCH_RENDER_AUTOPROVISION"))
	chain := plugins.SelectSearchChainNames()
	...
	kv(p, "CHATCLI_TRANSCRIPTION_KEY", presence(os.Getenv("CHATCLI_TRANSCRIPTION_KEY")))
	...
	kv(p, "CHATCLI_TTS_VOICE_FORMAT", envOr("CHATCLI_TTS_VOICE_FORMAT"))
	kv(p, "CHATCLI_TTS_URL", envOr("CHATCLI_TTS_URL"))
	kv(p, "CHATCLI_TTS_KEY", presence(os.Getenv("CHATCLI_TTS_KEY")))
	kv(p, "CHATCLI_TTS_CMD", envOr("CHATCLI_TTS_CMD"))
	kv(p, "CHATCLI_TTS_CMD_EXT", envOr("CHATCLI_TTS_CMD_EXT"))
	...
	kv(p, "CHATCLI_IMAGE_KEY", presence(os.Getenv("CHATCLI_IMAGE_KEY")))
	kv(p, "CHATCLI_IMAGE_STEPS", envOr("CHATCLI_IMAGE_STEPS"))

	fmt.Println(p)
	subheader(p, "cfg.sub.integ.lsp")
	kv(p, "CHATCLI_LSP_GO_CMD", envOr("CHATCLI_LSP_GO_CMD"))
	kv(p, "CHATCLI_LSP_TS_CMD", envOr("CHATCLI_LSP_TS_CMD"))
	kv(p, "CHATCLI_LSP_PYTHON_CMD", envOr("CHATCLI_LSP_PYTHON_CMD"))
	kv(p, "CHATCLI_LSP_RUST_CMD", envOr("CHATCLI_LSP_RUST_CMD"))
	kv(p, "CHATCLI_LSP_JAVA_CMD", envOr("CHATCLI_LSP_JAVA_CMD"))
	kv(p, "CHATCLI_LSP_RUBY_CMD", envOr("CHATCLI_LSP_RUBY_CMD"))
	kv(p, "CHATCLI_LSP_C_CMD", envOr("CHATCLI_LSP_C_CMD"))
	kv(p, "CHATCLI_LSP_CPP_CMD", envOr("CHATCLI_LSP_CPP_CMD"))

	fmt.Println(p)
	subheader(p, "cfg.sub.ui.output")
	kv(p, "CHATCLI_NO_TYPEWRITER", envBool("CHATCLI_NO_TYPEWRITER"))
	kv(p, "CHATCLI_TYPEWRITER_DELAY_MS", envOr("CHATCLI_TYPEWRITER_DELAY_MS"))
	kv(p, "CHATCLI_TYPEWRITER_BUDGET_MS", envOr("CHATCLI_TYPEWRITER_BUDGET_MS"))
	...
	if cli.isRemote {
		...
		kv(p, "CHATCLI_REMOTE_ADDR", envOr("CHATCLI_REMOTE_ADDR"))
		kv(p, "CHATCLI_REMOTE_TOKEN", presence(os.Getenv("CHATCLI_REMOTE_TOKEN")))
...
func (cli *ChatCLI) showConfigServer() {
	...
	serverVars := []string{
		...
		"CHATCLI_SERVER_TLS_CLIENT_CA", "CHATCLI_MTLS_ROLE",
		"CHATCLI_BIND_ADDRESS", "CHATCLI_GRPC_REFLECTION", "CHATCLI_SERVER_PIPELINE",
		"CHATCLI_JWT_SECRET", "CHATCLI_JWT_PUBLIC_KEY", "CHATCLI_JWT_ISSUER", "CHATCLI_JWT_AUDIENCE",
	...
	kv(p, "CHATCLI_SERVER_TLS_CLIENT_CA", envOr("CHATCLI_SERVER_TLS_CLIENT_CA"))
	kv(p, "CHATCLI_MTLS_ROLE", envOr("CHATCLI_MTLS_ROLE"))
	kv(p, "CHATCLI_SERVER_PORT", envOr("CHATCLI_SERVER_PORT"))
	kv(p, "CHATCLI_API_KEY", presence(os.Getenv("CHATCLI_API_KEY")))
	kv(p, "CHATCLI_CLIENT_API_KEY", presence(os.Getenv("CHATCLI_CLIENT_API_KEY")))
	kv(p, "CHATCLI_METRICS_PORT", envOr("CHATCLI_METRICS_PORT"))
	kv(p, "CHATCLI_GATEWAY_IN_SERVER", envBool("CHATCLI_GATEWAY_IN_SERVER"))
	kv(p, "CHATCLI_SERVER_PIPELINE", envBool("CHATCLI_SERVER_PIPELINE"))
	kv(p, "CHATCLI_MAX_RECV_MSG_SIZE", envOr("CHATCLI_MAX_RECV_MSG_SIZE"))
	kv(p, "CHATCLI_MAX_SEND_MSG_SIZE", envOr("CHATCLI_MAX_SEND_MSG_SIZE"))
	kv(p, "CHATCLI_MAX_CONCURRENT_STREAMS", envOr("CHATCLI_MAX_CONCURRENT_STREAMS"))

	fmt.Println(p)
	subheader(p, "cfg.sub.server.jwt")
	kv(p, "CHATCLI_JWT_SECRET", presence(os.Getenv("CHATCLI_JWT_SECRET")))
	kv(p, "CHATCLI_JWT_PUBLIC_KEY", envOr("CHATCLI_JWT_PUBLIC_KEY"))
	kv(p, "CHATCLI_JWT_ALGORITHM", jwtAlgorithmInEffect())
	...
	kv(p, "CHATCLI_WATCH_INTERVAL", envOr("CHATCLI_WATCH_INTERVAL"))
	kv(p, "CHATCLI_WATCH_WINDOW", envOr("CHATCLI_WATCH_WINDOW"))
	kv(p, "CHATCLI_WATCH_MAX_LOG_LINES", envOr("CHATCLI_WATCH_MAX_LOG_LINES"))
...
func (cli *ChatCLI) showConfigHub(ctx context.Context) {
	...
	kv(p, "CHATCLI_HUB_ENABLED", envBool("CHATCLI_HUB_ENABLED"))
	...
	fmt.Println(p)
	subheader(p, "cfg.sub.hub.channels")
	kv(p, "CHATCLI_SLACK_BOT_TOKEN", presence(os.Getenv("CHATCLI_SLACK_BOT_TOKEN")))
	kv(p, "CHATCLI_SLACK_SIGNING_SECRET", presence(os.Getenv("CHATCLI_SLACK_SIGNING_SECRET")))
	kv(p, "CHATCLI_SLACK_ADDR", envOr("CHATCLI_SLACK_ADDR"))
	kv(p, "CHATCLI_SLACK_PATH", envOr("CHATCLI_SLACK_PATH"))
	kv(p, "CHATCLI_TELEGRAM_BOT_TOKEN", presence(os.Getenv("CHATCLI_TELEGRAM_BOT_TOKEN")))
	kv(p, "CHATCLI_TELEGRAM_ALLOWED_USERS", envOr("CHATCLI_TELEGRAM_ALLOWED_USERS"))
	kv(p, "CHATCLI_DISCORD_BOT_TOKEN", presence(os.Getenv("CHATCLI_DISCORD_BOT_TOKEN")))
	kv(p, "CHATCLI_WHATSAPP_ACCESS_TOKEN", presence(os.Getenv("CHATCLI_WHATSAPP_ACCESS_TOKEN")))
	kv(p, "CHATCLI_WHATSAPP_VERIFY_TOKEN", presence(os.Getenv("CHATCLI_WHATSAPP_VERIFY_TOKEN")))
	kv(p, "CHATCLI_WHATSAPP_APP_SECRET", presence(os.Getenv("CHATCLI_WHATSAPP_APP_SECRET")))
	kv(p, "CHATCLI_WHATSAPP_PHONE_ID", envOr("CHATCLI_WHATSAPP_PHONE_ID"))
	kv(p, "CHATCLI_WHATSAPP_ADDR", envOr("CHATCLI_WHATSAPP_ADDR"))
	kv(p, "CHATCLI_WHATSAPP_PATH", envOr("CHATCLI_WHATSAPP_PATH"))
	kv(p, "CHATCLI_WEBHOOK_SECRET", presence(os.Getenv("CHATCLI_WEBHOOK_SECRET")))
	kv(p, "CHATCLI_WEBHOOK_ADDR", envOr("CHATCLI_WEBHOOK_ADDR"))
	kv(p, "CHATCLI_WEBHOOK_PATH", envOr("CHATCLI_WEBHOOK_PATH"))
	kv(p, "CHATCLI_WEBHOOK_CALLBACK_URL", envOr("CHATCLI_WEBHOOK_CALLBACK_URL"))
