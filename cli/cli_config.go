...
var reloadableEnvVars = []string{
	...
	"CHATCLI_PROMPT_CACHE_TTL", "CHATCLI_PROMPT_CACHE_EXPLICIT",
	"CHATCLI_COMPACT_MODEL", "CHATCLI_KNOWLEDGE_RERANK", "CHATCLI_KNOWLEDGE_NORMALIZE", "CHATCLI_MEMORY_PROVIDER", "CHATCLI_CONTEXT_ENGINE",
