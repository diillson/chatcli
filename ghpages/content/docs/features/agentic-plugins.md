...
O modo [/coder](/docs/core-concepts/coder-mode/) é especializado em engenharia de software e utiliza o plugin [@coder](/docs/features/coder-plugin/) para executar suas ações. O `@coder` é um **plugin builtin** — já vem embutido no ChatCLI e funciona sem instalação.
