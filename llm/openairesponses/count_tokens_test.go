...
func TestOpenAIResponsesCountTokens_GPTLocal(t *testing.T) {
	c := NewOpenAIResponsesClient(auth.NewStaticTokenProvider("k", auth.AuthModeAPIKey, auth.ProviderID("x")), "gpt-5.6-luna", zap.NewNop(), 1, time.Millisecond)
