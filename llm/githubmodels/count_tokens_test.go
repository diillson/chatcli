...
func TestGitHubModelsCountTokens_GPTLocal(t *testing.T) {
	c := NewGitHubModelsClient(auth.NewStaticTokenProvider("k", auth.AuthModeAPIKey, auth.ProviderID("x")), "gpt-4o", zap.NewNop(), 1, time.Millisecond)
