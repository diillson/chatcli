...
var _ client.TokenCounter = (*GitHubModelsClient)(nil)

// CountTokens implements client.TokenCounter.
func (c *GitHubModelsClient) CountTokens(_ context.Context, prompt string, history []models.Message) (int, error) {
